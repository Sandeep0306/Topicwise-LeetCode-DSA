...
Collections.max(Collection);                 // return the max element in the collection
Collections.min(Collection);                 // return the min element in the collection
